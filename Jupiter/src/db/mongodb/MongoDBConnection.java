...
public class MongoDBConnection implements DBConnection {
	...
	public void setFavoriteItems(String userId, List<String> itemIds) {
		...
		.updateOne(eq("user_id", userId), new Document("$push", new Document("favorite", new Document("$each", itemIds))));
	}
	...
	public void saveItem(Item item) {
		...
		FindIterable<Document> iterable = db.getCollection("items").find(eq("item_id", item.getItemId())); //if item_id == item.getItemId() 
		if (iterable.first() == null) {
